var experiment = {
  ...
  loadPhases : function(){
    ...
    if(this.group === 1){
      ...
      this.intervencion[0].push({contenido : '¿Cómo saber si funciona una medicina para curar el dolor de cabeza?<br>Para saber si funciona, necesitamos COMPARAR dos informaciones:<br><img class="center-block img-responsive" src="intervencion/Intervencion1.png"></img><br>'});
      this.intervencion[0].push({contenido : 'En el siguiente ejemplo, la medicina parece funcionar: de los que toman el tratamiento, se curan muchos, y de los que no lo toman, se curan pocos.<br><img class="center-block img-responsive" src="intervencion/Intervencion2.png"></img><br>'});
      this.intervencion[0].push({contenido : 'Sin embargo, la siguiente medicina parece que no funciona, ya que se cura aproximadamente el mismo porcentaje de gente tomando la medicina que sin tomarla.<br><img class="center-block img-responsive" src="intervencion/Intervencion3.png"></img><br>'});
      ...
      this.intervencion[1].push({contenido : '¿Cómo saber si funciona una medicina para curar el dolor de cabeza?<br>Para saber si funciona, necesitamos COMPARAR dos informaciones:<br><img class="center-block img-responsive" src="intervencion/Intervencion1.png"></img><br>'});
      this.intervencion[1].push({contenido : 'En el siguiente ejemplo, la medicina parece funcionar: de los que toman el tratamiento, se curan muchos, y de los que no lo toman, se curan pocos.<br><img class="center-block img-responsive" src="intervencion/Intervencion2.png"></img><br>'});
      this.intervencion[1].push({contenido : 'Sin embargo, la siguiente medicina parece que no funciona, ya que se cura aproximadamente el mismo porcentaje de gente tomando la medicina que sin tomarla.<br><img class="center-block img-responsive" src="intervencion/Intervencion3.png"></img><br>'});
