...
public class DefaultTheme extends ThemeBase {
	...
	private void loadLoginWindow()
	{
		...
		// TODO: Remove this, it should be done by LoginWindow
		final Image title = new Image(GWT.getModuleBaseURL() + "img/logo.png");
		title.setStyleName(DefaultTheme.Style.MAIN_TITLE);
