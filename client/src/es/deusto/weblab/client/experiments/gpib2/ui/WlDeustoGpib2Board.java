...
public class WlDeustoGpib2Board extends GpibExperiment {
	
	public static final String DEFAULT_GPIB2_WEBCAM_IMAGE_URL       = "http://gpib2.weblab.deusto.es/cliente/camview.jpg";
	
	public WlDeustoGpib2Board(IConfigurationRetriever configurationRetriever, IBoardBaseController commandSender) {
