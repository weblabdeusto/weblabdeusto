...
*
*/ 
package es.deusto.weblab.client.experiments.plugins.es.deusto.weblab.gpib2;
...
import es.deusto.weblab.client.experiments.plugins.es.deusto.weblab.gpib2.ui.WlDeustoGpib2Board;
...
public class WebLabGpib2Experiment extends WebLabGpibExperiment {
	...
	public WebLabGpib2Experiment(IConfigurationManager configurationManager, IBoardBaseController boardController) {
	...
	protected WlDeustoGpibBoard createGpibBoard(IConfigurationManager configurationManager, IBoardBaseController boardController){
		return new WlDeustoGpib2Board(configurationManager, boardController);
	}
}
