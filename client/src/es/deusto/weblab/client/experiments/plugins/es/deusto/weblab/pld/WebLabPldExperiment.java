...
*
*/ 
package es.deusto.weblab.client.experiments.plugins.es.deusto.weblab.pld;

import es.deusto.weblab.client.configuration.IConfigurationManager;
import es.deusto.weblab.client.experiments.ExperimentBase;
import es.deusto.weblab.client.experiments.plugins.es.deusto.weblab.pld.ui.WlDeustoPldBasedBoard;
