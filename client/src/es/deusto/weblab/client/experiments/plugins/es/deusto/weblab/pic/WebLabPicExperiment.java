...
*
*/ 
package es.deusto.weblab.client.experiments.plugins.es.deusto.weblab.pic;

import es.deusto.weblab.client.configuration.IConfigurationManager;
import es.deusto.weblab.client.experiments.ExperimentBase;
import es.deusto.weblab.client.experiments.plugins.es.deusto.weblab.pic.ui.WlDeustoPicBasedBoard;
