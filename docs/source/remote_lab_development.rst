...
.. note::
    ...
    If you are familiar with Python, you could go to http://developers.labsland.com/weblablib/
...
`weblablib <http://developers.labsland.com/weblablib/>`_ is a Python library which enables
...
Go to http://developers.labsland.com/weblablib/ to see how to use and install weblablib. Then, check :ref:`remote_lab_devel_unmanaged_http_deployment`.
