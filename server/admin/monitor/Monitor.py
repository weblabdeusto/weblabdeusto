...
try:
    ...
    print >> sys.stderr, "configuration.py not found; using default configuration; which might not work in load balancing configurations. Reason why configuration.py not found:", ie
    SERVERS = [ ("127.0.0.1", "31337") ]
