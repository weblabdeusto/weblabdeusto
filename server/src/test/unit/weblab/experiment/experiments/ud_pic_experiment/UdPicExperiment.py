...
class UdPicExperimentTestCase(unittest.TestCase):
    def setUp(self):
        self.urllib_mock = pmock.Mock()
        self.popen_mock  = pmock.Mock()
...
#       self.popen_mock.verify()
    ...
    def test_send_file(self):
        ...
        self.popen_mock.stdout.expects(
                ...
                pmock.return_value("tftp> tftp> tftp>")
            )
    ...
    def test_send_file_returns_nonzero(self):
        ...
        self.popen_mock.expects(
                ...
                pmock.return_value(-1) # There was an error!
            )
        self.popen_mock.stdout.expects(
                pmock.once()
            ).read().will(
    ...
    def test_send_file_not_sent_message(self):
        ...
        self.popen_mock.stdout.expects(
                ...
                pmock.return_value("this is not a sent message") # Message not expected
            )
    ...
    def test_send_file_stderr_used(self):
        ...
        self.popen_mock.stderr.expects(
                ...
                pmock.return_value("some message in stderr") # stderr used
            )
        self.urllib_mock.expects(
                pmock.once()
            ).urlopen(
