...
try:
    import ZSI
    from weblab.core.facade.generated.WebLabDeusto_client import WebLabDeustoSOAP as UserProcessingWebLabDeustoSOAP
except ImportError:
    pass
...
class UserProcessingIntegratingRemoteFacadeManager(unittest.TestCase):
    if UserProcessingFacadeServer.ZSI_AVAILABLE:
        ...
        print >> sys.stderr, "Optional library 'ZSI' not available. Tests in weblab.core.facade.Integrating skipped"
