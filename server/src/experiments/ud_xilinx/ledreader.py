...
if __name__ == '__main__':
    ...
    fpga = "https://cams.weblab.deusto.es/webcam/proxied.py/fpga1?-665135651"
    pld = "https://cams.weblab.deusto.es/webcam/proxied.py/pld1?1696782330"
    lr = LedReader(fpga, fpga_leds, 8, 10)
    lr.show()
