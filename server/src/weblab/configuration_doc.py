...
MAIL_NOTIFICATION_PREFIX   = 'mail_notification_prefix'
...
_sorted_variables.extend([
    ...
    (MAIL_SERVER_PORT,           _Argument(ADMIN_NOTIFIER, int,  -1, "Port to use for sending mail")),
...
if __name__ == '__main__':
    ...
    if options.format == 'gcode':
        ...
        print(".. note::")
        print()
        print("   At the time of this writing, not all the variables have been documented. We're working on this (June 2016).")
        print("   Take into account that these variablse are the type of variables you'll find in the .py configuration files. They are not variables for commands.")
        print()
