...
import weblab.user_processing.facade.UserProcessingFacadeManager as UPFM

try:
    import weblab.user_processing.facade.generated.WebLabDeusto_interface as WebLabDeusto_interface
except ImportError:
    ZSI_AVAILABLE = False
else:
    ZSI_AVAILABLE = True
