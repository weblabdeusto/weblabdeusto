...
from weblab.core.coordinator.coordinator import FINISH_FINISHED_MESSAGE, FINISH_DATA_MESSAGE, FINISH_ASK_AGAIN_MESSAGE, POST_RESERVATION_EXPIRATION_TIME, DEFAULT_POST_RESERVATION_EXPIRATION_TIME
