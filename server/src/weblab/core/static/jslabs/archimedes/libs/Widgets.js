...
RefreshingCameraWidget = function (targetid, imgsrc) {
    ...
    this.changeImg = function (targetid, imgsrc){
        mTargetId = targetid;
        mImgSrc = imgsrc;
    }
...
//! As a CSS string or a pixel-integer.
//! @param text Text beneath the image
BulWidget = function (pos_x, pos_y, text) {

    var mState;

    var mOffImg = "../../img/bulb_off.png";
    var mOnImg = "../../img/bulb_on.png";

    ImageWidget.call(this, pos_x, pos_y, text, "40px", "50px");
