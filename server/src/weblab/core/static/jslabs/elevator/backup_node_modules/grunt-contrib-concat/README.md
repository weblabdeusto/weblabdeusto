...
grunt.initConfig({
  concat: {
    basic: {
      src: ['src/main.controller.js'],
      dest: 'dist/basic.js',
    },
    extras: {
      src: ['src/main.controller.js', 'src/extras.js'],
...
grunt.initConfig({
  concat: {
    basic_and_extras: {
      files: {
        'dist/basic.js': ['src/main.controller.js'],
        'dist/with_extras.js': ['src/main.controller.js', 'src/extras.js'],
      },
    },
  },
});
...
grunt.initConfig({
  ...
  concat: {
    basic: {
      src: ['<%= dirs.src %>/main.controller.js'],
      dest: '<%= dirs.dest %>/basic.js',
    },
    extras: {
      src: ['<%= dirs.src %>/main.controller.js', '<%= dirs.src %>/extras.js'],
