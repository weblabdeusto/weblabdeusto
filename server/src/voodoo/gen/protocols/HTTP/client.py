...
import voodoo.gen.protocols.HTTP.errors as Exceptions
...
def generate(methods):
    ...
    class ClientHTTP(clientSkel):

        def __init__(self, url, port=80, uri='/'):
            # TODO: MyServer
            clientSkel.__init__(self,MyServer('http://'+url+':'+str(port)+uri, allow_none = True))
    ...
    for method_name in all_methods:
        ...
        for stub in stubs:
            ...
            setattr(ClientHTTP, func_name, func)
