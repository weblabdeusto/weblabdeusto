...
laboratory_assigned_experiments = [
        ...
        'exp1|ud-gpib|GPIB experiments;experiment_gpib:main_instance@main_machine',
        ...
        'exp1|visirtest|Dummy experiments;experiment_testvisir:main_instance@main_machine'
    ]
