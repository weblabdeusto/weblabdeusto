...
package es.deusto.weblab.client.experiments.robot_maze;

import com.google.gwt.core.client.GWT;
import com.google.gwt.core.client.RunAsyncCallback;

import es.deusto.weblab.client.configuration.IConfigurationRetriever;
import es.deusto.weblab.client.experiments.robot_maze.ui.RobotMazeExperiment;
...
public class RobotMazeCreatorFactory implements IExperimentCreatorFactory, IHasExperimentParameters {
			...
			public void createWeb(final IBoardBaseController boardController, final IExperimentLoadedCallback callback) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						callback.onExperimentLoaded(new RobotMazeExperiment(
