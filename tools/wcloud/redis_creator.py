...
if __name__ == '__main__':
    #Set arguments
    parser = argparse.ArgumentParser(description=  "Redis creator creates a set of idle redis instances to be used by the WebLab-Deusto instances."
    ...
    parser.add_argument('-p', '--port', metavar="INITIAL_PORT",
                        help="initial port",
    ...
    parser.add_argument('-t', '--template', dest='template', metavar="TEMPLATE_DIR",
